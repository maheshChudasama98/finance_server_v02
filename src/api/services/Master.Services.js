...
exports.SelectedCategoryService = async (req, res) => {
	const body = DevelopMood ? req.body : await decrypt(req.body?.key);
	const {httpCode, result} = await Controller.SelectedCategoryController(req?.user, body);
...
exports.SelectedSubCategoryService = async (req, res) => {
	const body = DevelopMood ? req.body : await decrypt(req.body?.key);
	const {httpCode, result} = await Controller.SelectedSubCategoryController(req?.user, body);
...
exports.SelectedLabelService = async (req, res) => {
	const body = DevelopMood ? req.body : await decrypt(req.body?.key);
	const {httpCode, result} = await Controller.SelectedLabelController(req?.user, body);
...
exports.SelectedAccountService = async (req, res) => {
	const body = DevelopMood ? req.body : await decrypt(req.body?.key);
	const {httpCode, result} = await Controller.SelectedAccountController(req?.user, body);
...
exports.SelectedPartyService = async (req, res) => {
	const body = DevelopMood ? req.body : await decrypt(req.body?.key);
	const {httpCode, result} = await Controller.SelectedPartyController(req?.user, body);
...
exports.SelectedLongsService = async (req, res) => {
	const body = DevelopMood ? req.body : await decrypt(req.body?.key);
	const {httpCode, result} = await Controller.SelectedLongsController(req?.user, body);
