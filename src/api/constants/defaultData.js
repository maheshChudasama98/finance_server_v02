...
module.exports.defaultCategoryList = [
  {
    ...
    Child: [
      ...
      },
      {
        ...
        Description:
          "Purchases of soft drinks, juices, and alcoholic beverages.",
      },
      {
        SubCategoriesName: "Restaurant & Fast-food",
        Icon: "fa-solid fa-bell-concierge",
        Description:
          "Eating out at restaurants, fast food joints, and takeaways.",
      },
      {
  ...
  },
  {
    ...
    Color: "#4fc3f7",
    Description:
      "Expenses related to buying clothes, electronics, and personal items.",
    Child: [
      {
      ...
      },
      {
        ...
        Description:
          "Purchases for children, including toys and baby products.",
      },
      {
  ...
  },
  {
    ...
    Color: "#0693E3",
    Description:
      "This category covers various modes of transportation, including business travel, long-distance travel, and public transport options.",
    Child: [
      {
        SubCategoriesName: "Business Trips",
        Icon: "fa-solid fa-suitcase",
        Description:
          "Covers transportation methods used for corporate travel, meetings, and work-related trips.",
      },
      {
        SubCategoriesName: "Long Distance",
        Icon: "fa-solid fa-plane-departure",
        Description:
          "Includes travel options for long-distance journeys, such as flights, intercity buses, and road trips.",
      },
      {
        SubCategoriesName: "Public Transport",
        Icon: "fa-solid fa-bus",
        Description:
          "Encompasses buses, trams, and other shared public transportation systems available for daily commuting.",
      },
      {
        SubCategoriesName: "Rail Way",
        Icon: "fa-solid fa-train-subway",
        Description:
          "Covers train and subway systems used for urban and long-distance commuting.",
      },
      {
        SubCategoriesName: "Taxi",
        Icon: "fa-solid fa-taxi",
        Description:
          "Includes taxis, ride-sharing services, and private car hires for short-distance travel.",
      },
    ],
  },
  {
    ...
    Color: "#9900EF",
    Description:
      "Covers expenses and services related to vehicle ownership and usage.",
    Child: [
      {
  ...
  },
  {
    ...
    Color: "#008B02",
    Description:
      "Covers activities, hobbies, and experiences that enhance life and entertainment.",
    Child: [
      {
        SubCategoriesName: "Active Sport, Fitness",
        Icon: "fa-solid fa-dumbbell",
        Description:
          "Expenses for gym memberships, sports, and fitness activities.",
      },
      {
      ...
      },
      {
        ...
        Icon: "fa-solid fa-tv",
        Description:
          "Subscription costs for streaming and television services.",
      },
      {
  ...
  },
  {
    ...
    Color: "#ff6900",
    Description:
      "Covers expenses related to communication, internet, and digital services.",
    Child: [
      {
  ...
  },
  {
    ...
    Color: "#00D084",
    Description:
      "Covers various financial obligations, including fees, loans, and taxes.",
    Child: [
      {
      ...
      },
      {
        ...
        Description:
          "Premiums for health, life, property, and other insurances.",
      },
      {
  ...
  },
  {
    ...
    Color: "#0073E6",
    Description:
      "Covers various types of investments, including financial assets, real estate, and savings.",
    Child: [
      {
        SubCategoriesName: "Collections",
        Icon: "fa-solid fa-gem",
        Description:
          "Investments in valuable collectibles like art, coins, and antiques.",
      },
      {
      ...
      },
      {
        ...
        Description:
          "Investments in real estate, including properties and land.",
      },
      {
        SubCategoriesName: "Savings",
        Icon: "fa-solid fa-piggy-bank",
        Description:
          "Funds saved in bank accounts, fixed deposits, and emergency funds.",
      },
      {
        SubCategoriesName: "Vehicles, Chattels",
        Icon: "fa-solid fa-car",
        Description:
          "Investments in cars, boats, and other valuable personal assets.",
      },
    ],
  },
  {
    ...
    Color: "#28A745",
    Description:
      "Tracks all sources of income, including salary, gifts, and sales.",
    Child: [
      {
